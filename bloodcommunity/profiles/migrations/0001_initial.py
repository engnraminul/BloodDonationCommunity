# Generated by Django 3.2.4 on 2021-07-15 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Blood_group_choice', models.CharField(choices=[('A+', 'A+'), ('A-', 'A-'), ('B+', 'B-'), ('O+', 'O+'), ('O-', 'O-'), ('AB+', 'AB+'), ('AB-', 'AB-')], max_length=11)),
                ('donation_activity', models.CharField(choices=[('Available', 'Available'), ('Notavailable', 'Notavailable')], max_length=50)),
                ('bio', models.TextField(default='NO bio data', max_length=300)),
